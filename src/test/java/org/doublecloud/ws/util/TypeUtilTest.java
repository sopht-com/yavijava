...
public class TypeUtilTest {
    ...
    @Test
    public void testIsPrimitiveType_boolean_is_Primitave() {
        assertTrue(TypeUtil.isPrimitiveType("boolean"));
    }

    @Test
    public void testIsPrimitiveType_Boolean_is_not_Primitave() {
    ...
    @Test
    public void testIsPrimitiveType_int_is_Primitave() {
        assertTrue(TypeUtil.isPrimitiveType("int"));
    }

    @Test
    public void testIsPrimitiveType_short_is_Primitave() {
        assertTrue(TypeUtil.isPrimitiveType("short"));
    }

    @Test
    public void testIsPrimitiveType_float_is_Primitave() {
        assertTrue(TypeUtil.isPrimitiveType("float"));
    }

    @Test
    public void testIsPrimitiveType_byte_is_Primitave() {
        assertTrue(TypeUtil.isPrimitiveType("byte"));
    }

    @Test
    public void testIsPrimitiveType_long_is_Primitave() {
        assertTrue(TypeUtil.isPrimitiveType("long"));
    }

    @Test
    public void testIsPrimitiveType_double_is_Primitave() {
        assertTrue(TypeUtil.isPrimitiveType("double"));
    }

    @Test
    public void testIsPrimitiveType_empty_string_is_not_Primitave_and_doesnt_throw_exception() {
        assertFalse(TypeUtil.isPrimitiveType(""));
    }

    @Test
    public void testIsBasicType_String_is_basic() {
        assertTrue(TypeUtil.isBasicType("String"));
    }

    @Test
    public void testIsBasicType_String_class_is_basic() {
        assertTrue(TypeUtil.isBasicType(String.class));
    }

    @Test
    public void testIsBasicType_int_is_basic() {
        assertTrue(TypeUtil.isBasicType("int"));
    }

    @Test
    public void testIsBasicType_int_class_is_basic() {
        assertTrue(TypeUtil.isBasicType(int.class));
    }

    @Test
    public void testIsBasicType_short_is_basic() {
        assertTrue(TypeUtil.isBasicType("short"));
    }

    @Test
    public void testIsBasicType_short_class_is_basic() {
        assertTrue(TypeUtil.isBasicType(short.class));
    }

    @Test
    public void testIsBasicType_long_is_basic() {
        assertTrue(TypeUtil.isBasicType("long"));
    }

    @Test
    public void testIsBasicType_long_class_is_basic() {
        assertTrue(TypeUtil.isBasicType(long.class));
    }

    @Test
    public void testIsBasicType_float_is_basic() {
        assertTrue(TypeUtil.isBasicType("float"));
    }

    @Test
    public void testIsBasicType_float_class_is_basic() {
    ...
    @Test
    public void testIsBasicType_byte_is_basic() {
        assertTrue(TypeUtil.isBasicType("byte"));
    }

    @Test
    public void testIsBasicType_byte__class_is_basic() {
        assertTrue(TypeUtil.isBasicType(byte.class));
    }

    @Test
    public void testIsBasicType_boolean_is_basic() {
        assertTrue(TypeUtil.isBasicType("boolean"));
    }

    @Test
    public void testIsBasicType_boolean_class_is_basic() {
    ...
    @Test
    public void testGetXSIType_byte_gives_xsd_byte() {
    ...
    public void testGetXSIType_Custom_Object_gives_RuntimeException() {
        class foo {
        }
    ...
    public void testGetXSIType_null_gives_NPE() {
